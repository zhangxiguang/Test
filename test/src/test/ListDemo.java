...
public class ListDemo {
	...
	public static void del() { // 删除
		...
		for (int i = 0; i < listone.size(); i++) {
			if (listone.get(i).getNumber() == number) {
				System.out.println("您要删除的学生信息为：" + listone.get(i));
	...
	public static void mod() { // 修改
		...
		for (int i = 0; i < listone.size(); i++) {
			if (listone.get(i).getNumber() == number) {
				System.out.println("您要修改的学生信息为：" + listone.get(i));
	...
	public static void showone() {// 查看一个
		...
		for (int i = 0; i < listone.size(); i++) {
			if (listone.get(i).getNumber() == number) {
				System.out.println("您要查看的学生信息为：" + listone.get(i));
	...
	public static void showall() { // 查看所有
		...
		System.out.println("共计" + listone.size() + "条信息已经全部输出。");
